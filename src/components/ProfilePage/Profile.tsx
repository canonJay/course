	...
	return (
		<div className='flex flex-col mt-4 w-full lg:max-w-[360px]'>
			...
			<div className='mt-4'>
				...
				<span className='w-full font-medium text-sm'>{data?.email}</span>
			</div>
			<div className='mt-4'>
				<span className='flex items-center gap-2 mt-1 text-base text-primary'>
				...
				<span className='w-full font-medium text-sm'>{data?.phone}</span>
			</div>
			<div className='mt-4'>
				<span className='flex items-center gap-2 mt-1 text-base text-primary'>
					<Send size={16} />
				...
				<span className='w-full font-medium text-sm'>{data?.telegramTag}</span>
			</div>
